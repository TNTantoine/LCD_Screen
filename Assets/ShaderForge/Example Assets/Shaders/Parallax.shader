    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_110 = (_HeightMultiplier*(node_574.a - 0.5)*mul(tangentTransform, viewDirection).xy + node_35);
