...
////// Specular:
                ...
                float3 node_2413 = (_Texture_var.rgb*_LuminosityBoost).rgb;
                float node_3807 = 1.0;
                ...
                float3 node_1534 = lerp(_Texture_var.rgb,float3((node_2413.r*_Pixel_Matrix_var.r),(node_2413.g*_Pixel_Matrix_var.g),(node_2413.b*_Pixel_Matrix_var.b)),(saturate((1.0 - saturate((distance(_WorldSpaceCameraPos,objPos.r)*0.005))))*0.5+0.5));
